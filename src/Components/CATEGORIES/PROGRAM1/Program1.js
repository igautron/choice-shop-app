...
class Program1 extends React.Component  {
            ...
            <div>
                <div className='mb-5 mt-3'>
                    <div className='container'>
                        ...
                        <h5 className='pb-5 slogan-text'>Збалансований природній комплекс для відновлення роботи серцево-судинної системи. До складу програми входять усі необхідні для нормального функціонування серця компоненти природнього походження</h5>
