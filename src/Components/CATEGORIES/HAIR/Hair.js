            ...
            <div>
                <div className='mb-5 mt-3'>
                    <div className='container'>
                        ...
                        <h5 className='pb-5 slogan-text'>Шампуні, маски та бальзами завдяки природньому складу відновлюють волосся та надають здоровий вигляд. Завдяки екстрактам пророщених зерен та різних олій шампуні та бальзами дію на ріст волосся.</h5>
