            ...
            <div>
                <div className='mb-5 mt-3'>
                    <div className='container'>
                        ...
                        <h5 className='pb-5 slogan-text'>Натуральні шампуні та молочко для тіла створені для дітей не містять у своєму складі сульфатів та фарбників. Створюють незабутній догляд малюкам. До складу входять лише природні компоненти.</h5>
